...
// Speed setpoint
static constexpr double ref_v = 50;
...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        // The rest of the constraints : the kinematic equations of the model
        for (int t = 1; t < N; t++) {
            ...
            AD<double> deriv = coeffs[1] + 2*coeffs[2]*x0 + 3*coeffs[3]*CppAD::pow(x0,2);
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
    ...
    // Return estimated positions & actuators values
